...
# plot_report_repertoire(sim_tcr,output_dir = "~/Documents/projet_long")
...
# 
# v_usage = read.csv("~/Documents/projet_long/donnees/v_usage.txt",sep=" ",header = TRUE)
...
# 
# j_usage = read.csv("~/Documents/projet_long/donnees/j_usage.txt",sep=" ",header = TRUE)
